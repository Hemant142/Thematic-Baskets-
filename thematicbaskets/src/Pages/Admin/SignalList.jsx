...
import { fetchSignals } from '../../Redux/algoandSignalsReducer/action';

export default function SignalList() {
    const location = useLocation();
    const dispatch = useDispatch();
    let token = Cookies.get("login_token_admin");
    let {signals,loading}=useSelector((store)=>store.algoandSignalReducer)

    useEffect(()=>{
  dispatch(fetchSignals(token))
    },[])
...
{/* <===================================== Add RA & RA List====================> */}
        <Tab
          ...
          fontWeight="bold"
          color={
            location.pathname === "/admin/addRA" ? "#244c9c" : "gray.500"
          }
          borderBottom={
            location.pathname === "/admin/addRA" && "2px solid"
          }
          borderColor={
            location.pathname === "/admin/addRA" && "#244c9c"
          }
          pb={2}
          _hover={{ color: "#244c9c" }}
          _focus={{ outline: "none" }}
...
{/* <=======================Client List and Dealer List=====================> */}
 <Tab
          ...
          borderBottom={
            location.pathname === "/admin/clientsList" && "2px solid"
          }
          borderColor={
            location.pathname === "/admin/clientsList" && "#244c9c"
          }
          pb={2}
          _hover={{ color: "#244c9c" }}
          _focus={{ outline: "none" }}
...
<Tab
          ...
          fontWeight="bold"
          color={
            location.pathname === "/admin/addDealer" ? "#244c9c" : "gray.500"
          }
          borderBottom={
            location.pathname === "/admin/addDealer" && "2px solid"
          }
          borderColor={
            location.pathname === "/admin/addDealer" && "#244c9c"
          }
          pb={2}
          _hover={{ color: "#244c9c" }}
          _focus={{ outline: "none" }}
